...
const Credits = () => {
  ...
  return (
    <div className="max-w-7xl h-screen  mx-auto overflow-y-scroll px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            <div className="flex-1">
              ...
              <p className="text-2xl font-bold text-purple-600 dark:text-purple-300 mb-4">
                ${plan.price}
                <span className="text-base font-nomal text-gray-600 dark:text-purple-200">
                  {" "}
