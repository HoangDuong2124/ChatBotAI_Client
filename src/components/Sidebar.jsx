...
const Sidebar = ({isMenuOpen, setIsMenuOpen}) => {
  ...
  return (
    ...
    >
      ...
      {/* New Chat Button */}
      <button
        className="flex items-center justify-center w-full mt-10 py-2 text-white 
      ...
      <div className="flex items-center gap-2 p-3 mt-4 border border-gray-400 dark:border-white/20 rounded-md">
        ...
        <input
          ...
          className="text-xs placeholder:text-gray-400  bg-transparent outline-none"
        />
      </div>
        ...
        {chats
          ...
          .map((chat) => (
            ...
            onClick={() => {navigate("/"); setSelectedChat(chat); setIsMenuOpen(false)}}
              key={chat.id}
              className="group flex justify-between p-2 px-4 drak:bg-[#57317C]/10 border border-gray-300 drak:border-[#80609F]/15 rounded-md cursor-pointer "
            >
              <div>
      ...
      <div
       ...
       dark:border-white/15 rounded-md cursor-pointer hover:scale-103 trasition-all"
      >
        <img
      ...
      <div
        ...
        className="flex items-center gap-2 p-3 mt-3 border border-gray-300
       dark:border-white/15 rounded-md cursor-pointer hover:scale-105 trasition-all"
      >
        <img
      ...
      {/* Dark Mode Toggle */}
      <div
        className="flex items-center justify-between gap-2 p-3 mt-3 border border-gray-300
      ...
      {/* User Account */}
      <div className=" group flex items-center gap-3 p-3 mt-3 border border-gray-300
      ...
      >
        ...
        />
         ...
         {user && <img src={assets.logout_icon} alt="" className="h-5 cursor-pointer hidden invert dark:invert-0 group-hover:block"/>}
      </div>
